...
function landing_scripts() {
	...
	wp_enqueue_style( 'landing-bootstrap', 'https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css' );

	wp_enqueue_script( 'landing-bootstrap-js', 'https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js', array('jquery'), '20180517', true );
